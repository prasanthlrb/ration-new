    ...
    <div id="landing">
        ...
        <nav id="navbar" ref="navbar" class="navbar navbar-expand-lg fixed-top sticky">
            <div class="container">
                <a class="navbar-brand text-dark fw-bold me-auto">
                    <div class="logo-box">
                        <img alt="" height="80" src="/assets/images/logo/logo.png">
                    </div>
                </a>
        ...
        <div class="hero-container pb-5">
            <div class="d-flex justify-content-center" style="margin-top: 70px">
                <img alt="" class="img-fluid" src="/assets/images/landing/hero-02.png">
            </div>
            <div class="row justify-content-center">

                <div class="col-lg-7 col-md-7 text-center">
                    <div class="title-heading">
                        <h1 class="fw-medium">RATION HOME - One Stop Ecommerce Solution</h1>
            ...
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between mt-5">
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <img alt="" class="d-block mx-auto ms-lg-auto" width="300"
                            src="/assets/images/landing/customer01.png" />
                    </div>
                </div>
                ...
                <Row class="mt-5">
                    ...
                    <div class="features feature-primary text-center">
                        ...
                        <div class="content mt-3">
                            <h5 class="fw-medium">Livestock</h5>
                    ...
                    <div class="features feature-primary text-center">
                        ...
                        <div class="content mt-3">
                            <h5 class="fw-medium">Butchery</h5>
                    ...
                    <div class="features feature-primary text-center">
                        ...
                        <div class="content mt-3">
                            <h5 class="fw-medium">Farm Products</h5>
                    ...
                    <div class="features feature-primary text-center">
                        ...
                        <div class="content mt-3">
                            <h5 class="fw-medium">Nuts and Spices</h5>
                ...
                <Row class="mt-5">
                    ...
                    <div class="features feature-primary text-center">
                        <div class="image position-relative d-inline-block">
                            <img alt="" src="/assets/images/module/fruits_vegetables.png" width="50">
                        </div>

                        <div class="content mt-3">
                            <h5 class="fw-medium">Fruits and vegetables</h5>
                            <p class="text-muted mb-0">Get food at your doorstep in snap</p>
                        </div>
                    </div>
                    </Col>
                    ...
                    <div class="features feature-primary text-center">
                        <div class="image position-relative d-inline-block">
                            <img alt="" src="/assets/images/module/fish.png" width="50">
                        </div>

                        <div class="content mt-3">
                            <h5 class="fw-medium">Fish</h5>
                            <p class="text-muted mb-0">We deliver grocery everyday as your routine</p>
                        </div>
                    </div>
                    </Col>
                    ...
                    <div class="features feature-primary text-center">
                        <div class="image position-relative d-inline-block">
                            <img alt="" src="/assets/images/module/wholesale_foodstuff.png" width="50">
                        </div>

                        <div class="content mt-3">
                            <h5 class="fw-medium">Wholesale foodstuff</h5>
                            <p class="text-muted mb-0">Find the best deals near your home</p>
                        </div>
                    </div>
                    </Col>
                    ...
                    <div class="features feature-primary text-center">
                        <div class="image position-relative d-inline-block">
                            <img alt="" src="/assets/images/module/Kitchen_hospitality.png" width="50">
                        </div>

                        <div class="content mt-3">
                            <h5 class="fw-medium">Kitchen and hospitality tools</h5>
                            <p class="text-muted mb-0">If you sick, don't worry we are for you</p>
                        </div>
                    </div>
                    </Col>
        ...
        <section class="odd">
            <div class="container">
                ...
                <div class="row align-items-center justify-content-between mt-5">
                    ...
                    <div class="col-lg-5">
                        <img alt="" class="d-block mx-auto ms-lg-auto" height="500"
                            src="/assets/images/landing/delivery_boy.png" />
                    </div>
                ...
                <div class="row align-items-center justify-content-between mt-5">
                    <div class="col-lg-5">
                        ...
                        <div class="d-flex flex-wrap gap-1 mt-4">
                            ...
                            <Button color="teal" flexed-icon @click="showSellerAppModal">
                                <Icon icon="vertical_align_bottom" size="18"></Icon>
                                <span class="ms-1-5 fw-medium"> Login</span>
                            </Button>
                            <Button class="ms-1-5" color="bluish-purple" flexed-icon variant="outline"
                    ...
                    <div class="col-lg-5 offset-lg-1">
                        <img alt="" class="d-block mx-auto ms-lg-auto" width="500"
                            src="/assets/images/landing/seller2.png" />
                    </div>
                </div>
                            ...
                            <li class="feature">
                                ...
                                <template v-else>
                                    <span class="text-danger">{{
                                        plan.admin_commission_type === 'percent' ? getPreciseCurrency(plan.admin_commission)
                                    + "%" : getFormattedCurrency(plan.admin_commission)
                                    }}</span> &nbsp; Commission
                                </template>
                            </li>
                        </ul>
        ...
        <section class="">
            <div class="container">
                <Row align-items="center">
                    <Col lg="7">
                    <div class="">
                        <h2 class="fw-medium mb-3">See everything about <span class="text-primary fw-semibold">{{
                            setup.business_name }}</span>
                            business</h2>
                        <p class=" text-muted ">Start working with <span class="text-primary fw-semibold">{{
                            setup.business_name }}</span> that can provide
                ...
                <CardBody>
                    <div class="d-flex justify-content-around">
                        <div class="text-center">
                            <img :src="getQRImageLink(app_links.play_store)" alt="" class="img-fluid d-block" width="250" />
                            <img alt="" class="mt-4 cursor-pointer" height="44" src="/assets/images/landing/play-store.png"
                                @click="onPlayStore">
                        </div>
                        <div class="text-center">
                            <img :src="getQRImageLink(app_links.ios_store)" alt="" class="img-fluid d-block" width="250" />
                            <img alt="" class="mt-4 cursor-pointer" height="44" src="/assets/images/landing/app-store.png"
                                @click="onIosStore">
                        </div>
                    </div>
                </CardBody>
