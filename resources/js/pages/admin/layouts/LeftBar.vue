                    ...
                    <template v-else>
                        <li class="side-nav-item">
                            <template v-if="hasItems(item)">
                                <a :id="'leftmenu_' + item.id" :href="`#collapse_` + item.id" class="side-nav-link"
                                    data-bs-toggle="collapse" :class="item.classList">
                                ...
                                <div :id="'collapse_' + item.id" class="collapse">
                                    <ul class="side-nav-second-level">
                                        <template v-for="subitem in item.children" :key="subitem.title">
                                            <li class="side-nav-item">
                                                <router-link :id="'leftmenu_' + subitem.id" :to="{ name: subitem.route }"
                                                    class="side-nav-link">
                            ...
                            <template v-else>
                                <router-link :id="'leftmenu_' + item.id"
                                    :to="item.route != null ? { name: item.route } : item.href" class="side-nav-link"
