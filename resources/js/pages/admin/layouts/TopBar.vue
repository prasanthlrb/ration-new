        ...
        <div class="navbar-header">
            ...
            <div class="d-flex align-items-center justify-content-end gap-2">
                ...
                <div class="topbar-item d-none d-md-flex">
                    <div :class="[{ 'fullscreen-enable': fullscreen_enable }]" class="topbar-button  hover-effect-circular"
                        @click="onFullScreen">
                        ...
                        <PageLoading :loading="notification_loading">
                            ...
                            <template v-for="notification in getNotifications">
                                <div class="py-0 px-2 d-flex align-items-start">
                                    <VItem align-items="center" circular class="p-1-5" color="success" display="flex" soft>
