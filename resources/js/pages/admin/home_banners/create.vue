            ...
            <Row>
                ...
                <Card>
                    <CardHeader :title="$t('general')" icon="edit_note" type="msr">
                        <div class="float-end">
                            <FormSwitch v-model="active" :errors="errors" :label="$t('active')" name="active" noSpacing />
                        </div>
                    </CardHeader>
                    <CardBody>

                        <FileUpload :default-files="null" :height=126 :max-files=1 :on-added="images_helper.onFileAdded"
                            :on-removed="images_helper.onFileRemoved" :validator="fileValidator" :label="$t('image')"
                            show-file-manager preview-as-list />
