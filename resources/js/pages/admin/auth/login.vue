        ...
        <div class="auth-content-wrapper">
            <div class="auth-content">
                <div class="d-flex justify-content-between align-items-center logo" style="padding: 40px 40px 0 40px">
                    <img alt="" class="dark" height="100" src="/assets/images/logo/logo.png">
                    <img alt="" class="light" height="100" src="/assets/images/logo/logo.png">
                ...
                <div class="my-auto" style="padding: 40px 60px">
                    ...
                    <div class="mt-4">
                        ...
                        <FormInput v-else v-model="mobile_number" :errors="errors" :label="$t('mobile_number')"
                            ...
                            <template #label-suffix>
                                <span class="text-primary float-end cursor-pointer" @click="toggleUsingEmail">{{ $t('email')
                                }}</span>
                            </template>
                        </FormInput>
                        ...
                        <div v-if="need_recaptcha" class="mt-4">
                            <VueRecaptcha :sitekey="getSiteKey" class="g-recaptcha" @error="onRecaptchaError"
                                @expired="onRecaptchaExpired" @verify="onRecaptchaVerified" />
                        ...
                        <div class="d-flex mt-3 justify-content-center">
                            ...
                            <div class="ms-2-5">
                                <LoadingButton :loading="loading" class="px-2-5 fw-medium py-1-5" flexed-icon icon="login"
                            ...
                            <div class="d-flex align-items-start cursor-pointer" @click="autoFill">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <p class="mb-0-5">
                                        ...
                                        <span class="ms-1-5">{{ dummy.email }}</span>
                                    </p>
                                    <p class="mb-0">
                                        <Icon icon="key" size="19" />
                                        <span class="ms-1-5">{{ dummy.password }}</span>
                                    </p>
                                </div>
                ...
                <div class="p-2-5 pb-3 text-center">
                    <span>Looking for <router-link :to="{ name: 'customer.home' }" class="fw-medium">Website</router-link>
                        -></span>
                </div>
            </div>
        </div>
